...
describe("HTTP route manifest", () => {
  test("keeps every registered method and path stable while routers are extracted", () => {
    ...
    expect(routes).toHaveLength(266 + ourRoutes.length);
